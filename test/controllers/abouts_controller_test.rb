...
class AboutsControllerTest < ActionController::TestCase
  ...
  test "should create about" do
    assert_difference('About.count') do
      post :create, about: { address: @about.address, description: @about.description, name: @about.name, phone: @about.phone }
    end
  ...
  test "should update about" do
    patch :update, id: @about, about: { address: @about.address, description: @about.description, name: @about.name, phone: @about.phone }
    assert_redirected_to about_path(assigns(:about))
  end
